...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"C:\projetos\front-end\src\pages\login\login.html"*/'\n\n\n\n<ion-content padding>\n\n    <label class="title">Login</label>\n\n\n\n  <div>\n\n    <label class="email">\n\n      Email\n\n    </label>\n\n    <p>\n\n      <input type="text" name="fname">\n\n  </div>\n\n  <div>\n\n    <label>\n\n      Senha\n\n    </label>\n\n    <p>\n\n      <input type="text" name="fname">\n\n      <label class="reset-password">Esqueceu a senha?</label>\n\n  </div>\n\n  <button ion-button class="button">LOGIN</button>\n\n  <p>\n\n  <button ion-button class="button-new">CRIAR CONTA</button>\n\n\n\n\n\n</ion-content>'/*ion-inline-end:"C:\projetos\front-end\src\pages\login\login.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]])
    ], LoginPage);
    return LoginPage;
